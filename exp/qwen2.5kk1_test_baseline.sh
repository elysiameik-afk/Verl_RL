...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name=Qwen2.5-0.5-Test-Baseline \
    trainer.experiment_name=Test_Baseline_GRPO_KK_v1 \
    trainer.n_gpus_per_node=1 \
    trainer.default_local_dir=/root/autodl-tmp/myverl/ckpts/Qwen2.5-0.5/Test_Baseline_v1 \
    trainer.nnodes=1 \
    trainer.save_freq=4 \
    trainer.test_freq=1 \
