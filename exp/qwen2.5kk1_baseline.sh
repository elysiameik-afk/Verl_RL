...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name=Qwen2.5-0.5-Baseline \
    trainer.experiment_name=Baseline_GRPO_KK_few_v1 \
    trainer.n_gpus_per_node=1 \
    trainer.default_local_dir=/root/autodl-tmp/myverl/ckpts/Qwen2.5-0.5/Baseline_GRPO_KK_few_v1 \
    trainer.nnodes=1 \
    trainer.save_freq=4 \
    trainer.test_freq=1 \
