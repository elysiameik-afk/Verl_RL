...
# HVR (Hybrid Value Reshaping) 最小内存配置训练脚本
# 专门为内存受限环境设计
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name=Qwen2.5-0.5-HVR-Minimal \
    trainer.experiment_name=HVR_GRPO_KK_minimal_v1 \
    trainer.n_gpus_per_node=1 \
    trainer.default_local_dir=/root/autodl-tmp/myverl/ckpts/Qwen2.5-0.5/HVR_GRPO_KK_minimal_v1 \
    trainer.nnodes=1 \
    trainer.save_freq=4 \
    trainer.test_freq=1 \
