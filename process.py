...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='/root/autodl-tmp/myverl/data/kk/kk2ppl_few')
    parser.add_argument('--hdfs_dir', default=None)
    parser.add_argument('--data_path', default='/root/autodl-tmp/myverl/data/people2_num200.jsonl')
    parser.add_argument('--train_size', type=int, default=130)
    parser.add_argument('--test_size', type=int, default=70)
